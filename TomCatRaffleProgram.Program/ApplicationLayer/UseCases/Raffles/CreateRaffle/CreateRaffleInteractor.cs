...
{
    public class CreateRaffleInteractor : IInteractor<CreateRaffleInputPort, ICreateRaffleOutputPort>
    {
        ...
        Task IInteractor<CreateRaffleInputPort, ICreateRaffleOutputPort>.HandleAsync(
